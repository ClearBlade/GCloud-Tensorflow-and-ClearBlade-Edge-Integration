...
### [Setup](#setup-1)
 1. #### [Setup on Google Cloud Platform](#setup-on-google-cloud-platform-1)
 2. #### [Setup on ClearBlade](#setup-on-clearblade-1)
### [Adapter Details](#adapter-details-1)
### [Usage](#usage-1)
 1. #### [Training Process](#training-process-1)
 2. #### [Testing Process](#testing-process-1)
