...
function value_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { value_typeof = function _typeof(obj) { return typeof obj; }; } else { value_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return value_typeof(obj); }
...
function timer_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { timer_typeof = function _typeof(obj) { return typeof obj; }; } else { timer_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return timer_typeof(obj); }
...
/* harmony default export */ var src_link = (function (links) {
  ...
  function initialize() {
    ...
    for (i = 0, count = new Array(n); i < m; ++i) {
      ...
      if (link_typeof(link.source) !== "object") link.source = link_find(nodeById, link.source);
      if (link_typeof(link.target) !== "object") link.target = link_find(nodeById, link.target);
...
function longitude(point) {
  if (abs(point[0]) <= src_math_pi) return point[0];else return math_sign(point[0]) * ((abs(point[0]) + src_math_pi) % src_math_tau - src_math_pi);
}
...
function containsLine(coordinates, point) {
  ...
  for (var i = 0, n = coordinates.length; i < n; i++) {
    ...
    if (i > 0) {
      ...
      if (ab > 0 && ao <= ab && bo <= ab && (ao + bo - ab) * (1 - Math.pow((ao - bo) / ab, 2)) < math_epsilon2 * ab) return true;
    }
